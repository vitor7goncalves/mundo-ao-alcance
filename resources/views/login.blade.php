...
@section('content')
    <div class="container-fluid d-flex flex-column align-items-center justify-content-center position-relative w-100">
        ...
        @endif
        <form action="{{ route('authenticate') }}" method="post" class="w-100">
            @csrf
